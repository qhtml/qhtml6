...
const qdomCorePath = path.join(__dirname, '..', '..', 'src', 'modules', 'qdom-core', 'src', 'qdom-core.js');
const parserPath = path.join(__dirname, '..', '..', 'src', 'modules', 'qhtml-parser', 'src', 'qhtml-parser.js');
